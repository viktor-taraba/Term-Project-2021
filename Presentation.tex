...
\begin{document}
	...
	\begin{frame}
		...
		\begin{center}
			...
			\bigskip
			\includegraphics[scale=0.55]{ind.jpg}
		\end{center}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\bigskip
			\end{itemize}
			\item \small Точка, в якій варто зупинити навчання моделі, аби уникнути перенавчання, визначалася автоматично за допомогою функції \textit{tf.keras.callbacks.EarlyStopping}. 
		\end{itemize}
	\end{frame}
