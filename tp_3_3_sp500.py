...
Original file is located at
    https://colab.research.google.com/drive/1cY3im2oBP3I7cC2IOOusQ6n1su2dotyC
"""
...
predictions = neural_network_analysis(32, 16, 64, False, SEED, X_train, y_train, X_valid, y_valid, 334)
output_data['Prediction 2'] = predictions
output_data

predictions = neural_network_analysis(32, 32, 128, False, SEED, X_train, y_train, X_valid, y_valid, 351)
output_data['Prediction 3'] = predictions
output_data

output_data.to_excel('SP500 output 1.xlsx')
